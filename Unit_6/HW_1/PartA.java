/*
Modify your program that you created that from the previous assignment (the one that calculates a test average using a partially partially filled array) and create a method called remove() that takes a reference to an array of doubles, the current size of the partially filled array (as an integer) and a target index value (as an integer) as arguments.  The method removes the element from the partially filled array at the target index and returns the updated current size of the partially filled array:
