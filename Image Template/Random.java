...
public class Random {
    ...
    public static void draw(Graphics g) {
        ...
        g.fill3DRect(0, 0, 400, 400, true);
        g.setColor(Color.GREEN);
        g.fill3DRect(0, 400, 400, 150, true);
        g.setColor(new Color(165, 42, 42));
        g.fill3DRect(200, 300, 30, 200, true);
        g.setColor(Color.GREEN);
        g.fillOval(0, 200, 250, 150);
        g.fillOval(150, 200, 250, 150);
        g.drawString("MY BEST ATTEMPT AT A TREE!?!", 100, 100);
